...
(
	...
	@cnpj varchar (18), @necessidadeesp varchar(3), @qualnecessidad varchar(50), @sabendoevento varchar(20)
)
AS
BEGIN
	INSERT INTO pessoas values (@edicaoempreend, @cpf, @rg, @nome, @datanasc, @email, @cep, @logradouro, @numero, @bairro, @cidade, @uf, @fixo, @celular, @escolaridade,
								@trabalha, @ondtrabalha, @ehempreendedor, @cnpj, @necessidadeesp, @qualnecessidad, @sabendoevento)
END
GO